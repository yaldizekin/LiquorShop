...
namespace LiquorShop.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var user=_context.AppUser.FirstOrDefault(i=>i.Email==Input.Email);
                    int count = _context.ShoppingCart.Where(i => i.AppUserId == user.Id).Count();
